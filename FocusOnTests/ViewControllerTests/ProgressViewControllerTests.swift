...
class ProgressViewControllerTests: XCTestCase {
  ...
  func testGivenProgressViewDidLoad_WhenProgressViewWillAppear_thenDataNotEmpty() {
    ...
    progressViewController.setupDataController(dataController)
    if progressViewController.view == nil {
      XCTFail("View did not Load")
    }
    progressViewController.viewWillAppear(false)
    XCTAssertEqual(progressViewController.labels.isEmpty, false)
    XCTAssertEqual(progressViewController.completedGoals.isEmpty, false)
    XCTAssertEqual(progressViewController.completedTasks.isEmpty, false)
  }
  
  func testGivenProgressViewDidLoad_WhenProgressViewWillDisappear_thenDataEmpty() {
    dataForCurrentMonth()
    dataForCurrentYear()
    ...
    progressViewController.viewWillDisappear(false)
    XCTAssertEqual(progressViewController.labels.isEmpty, true)
    XCTAssertEqual(progressViewController.completedGoals.isEmpty, true)
    XCTAssertEqual(progressViewController.completedTasks.isEmpty, true)
  }
